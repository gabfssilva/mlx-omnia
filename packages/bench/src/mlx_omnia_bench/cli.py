...
from mlx_omnia_bench.arms import omnia
from mlx_omnia_bench.battery import Comparison, default_gate, interleaved
from mlx_omnia_bench.ceiling import ceiling
from mlx_omnia_bench.gate import Cool
from mlx_omnia_bench.paired import Side, git, git_root, paired, worktree
from mlx_omnia_bench.prompt import BENCH_PROMPT, tile
from mlx_omnia_bench.report import Calibration, stderr
...
def run_interleaved(args: argparse.Namespace) -> None:
    ...
    if args.against == "mlx-lm":
        from mlx_omnia_bench.arms import mlx_lm
...
def run_paired(args: argparse.Namespace) -> None:
    ...
    side = {
        "build": "mlx_omnia_bench.arms.omnia:build",
        "config": config,
        "roots": (ENGINE_ROOT,),
        "verify": ("mlx_omnia",),
    }
