...
is an `.npz` under `~/.cache/sideros/fidelity/`, and `DELETE` unlinks both. A cache nobody
...
from sideros_server.store import ReferenceCache, Store

CACHE = Path.home() / ".cache" / "sideros" / "fidelity"
