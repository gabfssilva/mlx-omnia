...
from mlx_omnia.footprint import active_bytes_per_token, checkpoint_bytes, resident_bytes
...
from mlx_omnia.quant.quantization import Quantization
from mlx_omnia.quantizing import Quantizing, admits
from mlx_omnia_server.metrics import Metrics, RequestState
...
def _checkpoint_size(model_id: str) -> int:
    ...
    """
    from mlx_omnia.task import MTP_PREFIX
    from mlx_omnia_server.catalog import scan
...
def _incoming_size(model_id: str, store: Store) -> int:
    ...
    from mlx_omnia_server.features import drafter_bytes
...
def drafter(model: object) -> nn.Module | None:
    ...
    from mlx_omnia_server.features import drafting
...
def _verdict(model_id: str, trunk: _CausalLM, policy: Compression) -> str | None:
    ...
    """
    from mlx_omnia_server.catalog import kv_head_width
...
class Engine:
    ...
    async def _compress(
        ...
        """
        from mlx_omnia_server.features import compressing
    ...
    def _spill(self, model_id: str) -> DiskSpill | None:
        ...
        """
        from mlx_omnia_server.catalog import stamp_of
