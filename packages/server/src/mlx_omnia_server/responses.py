...
`mlx_omnia.schema` over the text that came back. What stays in each route is the shape of the
...
from mlx_omnia.parsers import MalformedToolCall, Segment, ToolCall, ToolFamily
