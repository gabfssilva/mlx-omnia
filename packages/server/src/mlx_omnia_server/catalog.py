...
from mlx_omnia.checkpoint import QuantizationJson, SamplingDefaults, sampling_defaults
from mlx_omnia.footprint import expert_slots
from mlx_omnia.task import source as checkpoint_source
...
def remove(model_id: str, loaded: Resident, store: StoreDep) -> None:
    from mlx_omnia_server.prefixes import forget
