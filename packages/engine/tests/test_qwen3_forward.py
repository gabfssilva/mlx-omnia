...
from mlx_omnia.models.qwen3.dense import CHECKPOINT
from mlx_omnia.models.qwen3.model import Qwen3, Qwen3Activations
...
def test_rope_epilogue_matches_op_path(
    ...
    monkeypatch.setattr("mlx_omnia.models.qwen3.layers.attention.rope_epilogue_applies", never)
