...
from sideros.models.nemotron_h.config import ATTENTION, MOE, BlockKind, NemotronHConfig
from sideros.models.nemotron_h.model import NemotronH
from sideros.models.nemotron_h.mtp import NemotronHMTP
from sideros.quant.quantization import QuantizationPlan
...
def load_mtp(directory: Path, dtype: mx.Dtype | None = None) -> NemotronHMTP:
    ...
    target's 14 shards. It still does not go through `sideros.load` — it serves no task, has
