...
from sideros.models.olmo2.model import Olmo2


def weights(directory: Path, config: Olmo2Config, dtype: mx.Dtype | None) -> dict[str, mx.array]:
...
def _composite(directory: Path, model: Olmo2) -> LanguageModel[ModelInput]:
