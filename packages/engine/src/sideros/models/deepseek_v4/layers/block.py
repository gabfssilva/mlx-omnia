...
from sideros.models.deepseek_v4.layers.hyper import HyperConnection, HyperHead, hc_expand
from sideros.models.deepseek_v4.layers.moe import DeepseekV4MoE
