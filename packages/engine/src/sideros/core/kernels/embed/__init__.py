...
from sideros.core.kernels.embed.atlas import AtlasEmbed
from sideros.core.kernels.embed.default import DefaultEmbed
from sideros.core.kernels.embed.kernel import EmbedStrategy
