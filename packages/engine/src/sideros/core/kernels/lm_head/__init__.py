...
from sideros.core.kernels.lm_head.argmax import ArgmaxGreedyHead
from sideros.core.kernels.lm_head.default import DefaultGreedyHead
from sideros.core.kernels.lm_head.kernel import GreedyHeadStrategy, HeadProjection
