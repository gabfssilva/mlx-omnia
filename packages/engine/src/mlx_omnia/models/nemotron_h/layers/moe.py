...
from mlx_omnia.core.kernels.moe_step import MoeStep
from mlx_omnia.core.kernels.route import Route
from mlx_omnia.core.layers import SORTED_GATHER_MIN, sorted_gather
from mlx_omnia.models.nemotron_h.config import NemotronHConfig
from mlx_omnia.models.nemotron_h.layers.mlp import NemotronHMLP, SwitchMLP
...
class NemotronHGate(nn.Module):
    ...
    def __call__(self, x: mx.array) -> tuple[mx.array, mx.array]:
        ...
        if length <= 4 and self.n_group == 1:
            ...
            from mlx_omnia.core.kernels.route import SigmoidWideRoute
...
class NemotronHMoE(nn.Module):
    ...
    def __call__(self, x: mx.array) -> mx.array:
        ...
        if 1 < length <= 4 and "fc2_latent_proj" not in self:
            from mlx_omnia.core.kernels.moe_step import Nvfp4MoeStep
