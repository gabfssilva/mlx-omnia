...
Seven things no other Omnia model has:
...
from mlx_omnia.models.longcat_flash_ngram.checkpoint import CHECKPOINT
from mlx_omnia.models.longcat_flash_ngram.config import (
    LongcatFlashNgramConfig,
    LongcatFlashNgramRopeScaling,
)
from mlx_omnia.models.longcat_flash_ngram.model import (
    LongcatFlashNgram,
