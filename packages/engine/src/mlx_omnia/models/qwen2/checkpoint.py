...
from mlx_omnia.models.qwen2.config import Qwen2Config
from mlx_omnia.models.qwen2.model import Qwen2


def weights(directory: Path, config: Qwen2Config, dtype: mx.Dtype | None) -> dict[str, mx.array]:
