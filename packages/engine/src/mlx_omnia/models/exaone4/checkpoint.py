...
from mlx_omnia.models.exaone4.model import Exaone4


def weights(directory: Path, config: Exaone4Config, dtype: mx.Dtype | None) -> dict[str, mx.array]:
...
def _composite(directory: Path, model: Exaone4) -> LanguageModel[ModelInput]:
