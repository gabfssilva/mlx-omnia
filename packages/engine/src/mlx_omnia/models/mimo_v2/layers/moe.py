...
from mlx_omnia.core.layers import SORTED_GATHER_MIN, SwitchGLU, sorted_gather
from mlx_omnia.models.mimo_v2.config import MimoV2Config


class MimoV2Gate(nn.Module):
...
class MimoV2MoE(nn.Module):
    ...
    def __call__(self, x: mx.array) -> mx.array:
        ...
        return (routed * mx.expand_dims(weights, -1)).sum(axis=-2).astype(x.dtype)
