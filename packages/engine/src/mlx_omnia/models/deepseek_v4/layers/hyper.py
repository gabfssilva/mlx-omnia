...
from mlx_omnia.core.kernels.hyper_connection import FusedHyperConnection
from mlx_omnia.core.kernels.hyper_connection import HyperConnection as HyperJunction
