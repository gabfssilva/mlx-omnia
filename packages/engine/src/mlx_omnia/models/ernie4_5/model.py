...
from mlx_omnia.models.ernie4_5.layers.block import Ernie45Block
...
class Ernie45(nn.Module):
    ...
    def activations(self, ids: mx.array, cache: list[KVCache] | None = None) -> Ernie45Activations:
