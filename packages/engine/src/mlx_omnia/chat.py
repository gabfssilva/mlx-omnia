...
from mlx_omnia.language import TEXT, GenerationOptions, LanguageModel, LanguagePrompt, Text
...
from mlx_omnia.parsers import Parser, Segment, parser_for
...
CHAT = ContentType(Modality.TEXT, "application/vnd.mlx_omnia.chat")
