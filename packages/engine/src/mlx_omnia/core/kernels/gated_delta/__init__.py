...
from mlx_omnia.core.kernels.gated_delta.default import DefaultGatedDelta, delta_rule
from mlx_omnia.core.kernels.gated_delta.fused import (
    FusedGatedDelta,
    gated_delta,
    gated_delta_applies,
)
from mlx_omnia.core.kernels.gated_delta.kernel import GatedDeltaStrategy
