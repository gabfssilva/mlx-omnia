...
from mlx_omnia.core.kernels.lm_head.argmax import ArgmaxGreedyHead
from mlx_omnia.core.kernels.lm_head.default import DefaultGreedyHead
from mlx_omnia.core.kernels.lm_head.kernel import GreedyHeadStrategy, HeadProjection
