...
from mlx_omnia.core.cache_file import policy
from mlx_omnia.core.mxcompat import softmax
from mlx_omnia.core.prefill import ARRIVING, BLOCK, pulled
from mlx_omnia.core.prompt_cache import PromptCache
from mlx_omnia.parsers import FALLBACK, Parser, Segment, Segmenter
...
class Constraint(Protocol):
    ...
    token that `LogitFilter` has nowhere to put. `mlx_omnia.grammar` is the implementation.
