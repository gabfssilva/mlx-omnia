...
from sideros_application.api.daemon import FOREIGN, Daemon
from sideros_application.api.engine import GIB, CatalogEntry, Engine
from sideros_application.ui import parts, theme
from sideros_application.ui.chrome import Chrome
from sideros_application.ui.format import display_name, gb
from sideros_application.ui.hooks import act, use_tick
            ...
            [
                ft.Column(
                    [
                        ...
                        parts.kvr(
                            "Version",
                            f"sideros {'—' if system is None else system['version']}",
