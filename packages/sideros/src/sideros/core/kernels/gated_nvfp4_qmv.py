...
Its decode geometry is `nvfp4_qmv`'s -- split-nibble `half2` spread, `2^22` folded out of
...
instead of `nvfp4_qmv`'s single `ushort`; that is the only structural difference between
