...
from sideros.models.ernie4_5.model import Ernie45


def weights(directory: Path, config: Ernie45Config, dtype: mx.Dtype | None) -> dict[str, mx.array]:
...
def _composite(directory: Path, model: Ernie45) -> LanguageModel[ModelInput]:
