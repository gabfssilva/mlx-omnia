...
The tree is the house's dense decoder (`core/dense.py`), leaf for leaf — the delta is
...
from sideros.models.smollm3.checkpoint import CHECKPOINT
from sideros.models.smollm3.config import SmolLM3Config, SmolLM3RoPEScalingConfig
from sideros.models.smollm3.model import SmolLM3
