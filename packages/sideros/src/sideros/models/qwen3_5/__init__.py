...
from sideros.models.qwen3_5.checkpoint import CHECKPOINT
from sideros.models.qwen3_5.config import Qwen35Config, Qwen35RoPEParameters, Qwen35TextConfig
from sideros.models.qwen3_5.layers.moe import Qwen35MoE
from sideros.models.qwen3_5.model import (
    MultimodalPrompt,
    Qwen35,
    Qwen35Activations,
    Qwen35Input,
