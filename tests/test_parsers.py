...
from mlx_omnia.engine.parsers import FALLBACK, Parser, Segment, Segmenter, ToolCall
from mlx_omnia.engine.parsers.harmony import PARSER as HARMONY
...
def atem_parser() -> Parser:
    from mlx_omnia.engine.parsers.atem import PARSER
