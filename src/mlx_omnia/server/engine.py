...
def _measured() -> int:
    ...
    from mlx_omnia.server.state import footprint_bytes
...
def _checkpoint_size(model_id: str) -> int:
    ...
    from mlx_omnia.server.catalog import scan
...
def _incoming_size(model_id: str, store: Store) -> int:
    ...
    from mlx_omnia.server.features import drafter_bytes
...
def drafter(model: object) -> nn.Module | None:
    ...
    from mlx_omnia.server.features import drafting
...
def _verdict(model_id: str, trunk: _CausalLM, policy: Compression) -> str | None:
    ...
    """
    from mlx_omnia.server.catalog import kv_head_width
...
class Engine:
    ...
    async def _compress(
        ...
        """
        from mlx_omnia.server.features import compressing
    ...
    def _spill(self, model_id: str) -> DiskSpill | None:
        ...
        """
        from mlx_omnia.server.catalog import stamp_of
