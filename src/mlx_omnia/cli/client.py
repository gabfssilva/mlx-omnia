"""HTTP client for the mlx_omnia daemon. This package never imports the engine.

What this package exists to prove — `uv tree --package mlx-omnia-cli` showing httpx and its
