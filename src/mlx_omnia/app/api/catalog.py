"""The Library's own routes, typed off `mlx_omnia/server/download.py` and `catalog.py`, and
...
from mlx_omnia.app.api.engine import Job
from mlx_omnia.app.api.http import at
